 ...
 * @date 2022-11-02
 * @brief This is the implementation to open/close the shared memory
 * @details This file implements the methods to open/close the shared memory
 *
 */
#include <fcntl.h>
#include <stdlib.h>
...
struct sharedMemory *openSharedMemory(int *shmfd, char role)
{
    ...
    int oFlag = (role == 'c') ? O_RDWR : O_RDWR | O_CREAT | O_EXCL;
